import {
  ACTION_SET_FROM,
  ACTION_SET_TO,
  ACTION_SET_IS_CITY_SELETORVISIBLE,
  ACTION_SET_CURRENT_SELETOR_LEFT_CITY,
...
export default {
  ...
  isCitySelectorVisible(state = false, action) {
      const { type, payload } = action;
      switch (type) {
          case ACTION_SET_IS_CITY_SELETORVISIBLE:
              return payload;
          default:
      }
  ...
  currentSelectingLeftCity(state = false, action) {
      const { type, payload } = action;
      switch (type) {
          case ACTION_SET_CURRENT_SELETOR_LEFT_CITY:
              return payload;
          default:
      }
  ...
  isDateSelectorVisible(state = false, action) {
      const { type, payload } = action;
      switch (type) {
          case ACTION_SET_IS_DATE_SELETORVISIBLE:
              return payload;
          default:
      }
